...
export default function HexagonHex({ hexField, mode }: HexagonHexProps) {
  ...
  const hexagonCss =
    mode === GameMode.CLASSIC
      ? "p-3 sm:p-4 md:p-5 lg:p-6 basis-16 sm:basis-20 md:basis-28 lg:basis-36 xl:basis-40 mx-0.5 sm:mx-0.5 md:mx-0.5 lg:mx-1"
      : "p-2 sm:p-4 md:p-5 xl:p-6 basis-10 sm:basis-16 md:basis-20 lg:basis-28 xl:basis-36 mx-0.5 sm:mx-0.5 md:mx-0.5 lg:mx-0.5";
  const textColor =
